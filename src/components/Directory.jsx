...
const personalitiesData = [
  ...
  // Deceased Numberdars
  {
    ...
    image: '/images/people/lal khan.webp',
  ...
  // Alive Numberdars
  {
    ...
    image: '/images/people/waris Numberdar.webp',
  ...
  },
  {
    ...
    image: '/images/people/Hazir.webp',
    achievement: { en: 'Active Village Numberdar', ur: 'موجودہ نمبردار' },
  },
  {
    id: 6,
  ...
  // Martyr (Shaheed) Police
  {
    ...
    image: '/images/people/Naeem Shaheed.webp',
  ...
  // Alive Police Officers
  {
    ...
    image: '/images/people/Sadat.webp',
  ...
  },
  {
    ...
    image: '/images/people/Afzal jatoi.webp',
    achievement: { en: 'Police Inspector', ur: 'پولیس انسپکٹر' },
  },
  {
    id: 306,
    ...
    image: '/images/people/Ajmal.webp',
  ...
  {
    id: 310,
    name: { en: 'Wajib Police', ur: 'واجب پولیس' },
    type: 'Police',
    field: { en: 'Police Department (Alive)', ur: 'محکمہ پولیس (حیات)' },
    category: 'Alive',
    bio: {
  ...
  // ================= TEACHERS =================
  {
    ...
    image: '/images/people/israr.webp',
  ...
  },
  {
    ...
    image: '/images/people/wassem.webp',
  ...
  },
  {
    ...
    image: '/images/people/Master Abbas.webp',
  ...
  },
  {
    ...
    image: '/images/people/Bashir Ahmad.webp',
  ...
  {
    id: 409,
    name: { en: 'Sir Wazir Ali', ur: 'سر وزیر علی' },
    type: 'Teacher',
    field: { en: 'Educator / Teacher (Deceased)', ur: 'استاد / ماہر تعلیم (مرحوم)' },
    category: 'Deceased',
    bio: {
  ...
  },
  {
    ...
    image: '/images/people/Sami ullah.webp',
  ...
  },
  {
    ...
    image: '/images/people/Jalal.webp',
  ...
  },
  {
    ...
    image: '/images/people/umer fayyaz.webp',
    achievement: { en: 'Advocate / Lawyer', ur: 'ایڈوکیٹ' },
  },
    {
    id: 605,
    ...
    image: '/images/people/Iqrar.webp',
    achievement: { en: 'Advocate / Lawyer', ur: 'ایڈوکیٹ' },
  },
];
  ...
  return (
    <section id="directory" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* —— Cards Grid with 3D Tilt & Reordering —— */}
        {filtered.length > 0 ? (
          <motion.div layout className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-6">
            <AnimatePresence>
              {filtered.map(person => {
                ...
                return (
                  ...
                  >
                    <TiltCard
                      className="group relative bg-white rounded-2xl sm:rounded-3xl border border-gray-100 hover:border-brand-moss/30 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col h-full"
                    >
                      {/* Photo Area */}
                      <div 
                      ...
                      <div className="p-3 sm:p-6 flex flex-col flex-1">
                        ...
                        <p className="text-[10px] sm:text-xs font-semibold text-brand-gold uppercase tracking-wider mb-2">
                          {get(person.field, lang)}
                        </p>
                        <p className="text-gray-500 text-[10px] sm:text-xs leading-relaxed line-clamp-3 mb-3 flex-1">
                          {get(person.bio, lang)}
                        </p>

                        {person.achievement && (
                          <div className="pt-2 border-t border-gray-100 flex items-center gap-1 text-[9px] sm:text-[11px] font-medium text-brand-emerald">
                            <Star className="w-3 h-3 text-brand-gold fill-brand-gold shrink-0" />
                            <span className="truncate">{get(person.achievement, lang)}</span>
                          </div>
                        )}
                      </div>
                    </TiltCard>
